    ...
    <section>
        <div class="container-lg d-flex flex-column justify-content-center align-items-center py-5 my-5">
            <div class="textarea-l mb-5">
                <h1 id="about_us">Raw Denim Heirloom Man Braid</h1>
                    ...
                    <div class="col">
                        <div class="card h-100" >
                            <div class="card-block p-4 rounded">
                                <img src="{{ $newsData->img }}" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <span class="color-a ">{{ $newsData->data }}</span>
                ...
                @foreach ($productDatas as $productData)
                    <div class="col mb-3">
                        <div class="card h-100 d-flex flex-column justify-content-between">
                            <img class="mb-3" src="{{ $productData->img }}" alt="">
                            <h3 class="fs-6">{{ $productData->name }}</h3>
